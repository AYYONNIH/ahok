...
creator = 'Ayyonh😂😂' // GAK USAH DI UBAH ANJING HARGA CREATOR
asal = 'Surabaya' // UBAH NAMA LU
//━━━━━━━━━━━━━━━[ MODUL EXPORTS ]━━━━━━━━━━━━━━━━━//
...
"body": `hy`, 
"mediaType": "2", 
"mediaUrl": "https://youtu.be/ac5czQryBoM", 
...
const daftar2 = 'Jangan Lupa Subscribe Ayyon Bot\nhttps://youtube.com/ZeroYT7'
...
but = [
        ...
        sendButImage(from, teks, "©Ayyon Bot", gam, but)
break
...
costum(buffer, sticker, Verived, `Jangan Lupa Subscribe Ayyon Bot`)
fs.unlinkSync(media)
fs.unlinkSync(ran)
})
...
buffer = fs.readFileSync(ran)
costum(buffer, image, Verived, `Jangan Lupa Subscribe Ayyon Bot`)
fs.unlinkSync(ran)
})
break
case 'tomp3':
...
fs.unlinkSync(anum)
buffer = fs.readFileSync(ran)
zeroyt7.sendMessage(from, buffer, video, { quoted: ftrol, caption: 'Done... Jangan Lupa Subscribe Ayyon Bot' })
fs.unlinkSync(ran)
})
break
...
reply('TUHH NOMER OWNER KU SPAM GAPAPA')
break
case 'bc':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
if (!isOwner) return reply('LU BUKAN OWNER GBLOK:v')
...
for (let _ of anu) {
sendMess(_.jid, `[ *Ayyon Bot BROADCAST* ]\n\n${body.slice(4)}`)
}
reply('Suksess broadcast')
}
break
...
zeroyt7.sendMessage(`62895606093746@s.whatsapp.net`, options, text, { quoted: ftrol })
...
await zeroyt7.sendMessage(from, get_audio, video, { mimetype: 'video/mp4', filename: `${get_result.title}.mp4`, quoted: ftrol, caption: 'Nih Jangan Lupa Subscribe Ayyon Bot'})
break
case 'tiktok':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
if (args.length == 0) return reply(`Link Nya Mana Tod\nContoh: ${prefix + command} https://www.youtube.com/watch?v=qZIQAk-BUEc`)
...
await zeroyt7.sendMessage(from, ini_buffer, video, { quoted: ftrol, caption: 'Nih Jangan Lupa Subscribe Ayyon Bot'})
break
case 'tiktokmusic':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
await zeroyt7.sendMessage(from, ini_buffer, image, { quoted: ftrol, caption: 'Nih Jangan Lupa Subscribe Ayyon Bot'})
break
//━━━━━━━━━━━━━━━[ FITUR ANIME ]━━━━━━━━━━━━━━━━━//
...
reply(mess.wait)
zeroyt7.sendMessage(from, gambar, image, { quoted: ftrol, caption: 'Nih Jangan Lupa Subscribe Ayyon Bot'})
})
break
case 'chiisaihentai':
case 'trap':
...
zeroyt7.sendMessage(from, buffer, video, {quoted: ftrol, caption: 'Nih Jangan Lupa Subscribe Ayyon Bot'})
break
case 'asupancecan':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
zeroyt7.sendMessage(from, buffer, image, {quoted: ftrol, caption: 'Nih Jangan Lupa Subscribe Ayyon Bot'})
break
case 'asupanhijaber':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
zeroyt7.sendMessage(from, goo, image, {quoted: ftrol, caption: 'Nih Jangan Lupa Subscribe Ayyon Bot'})
break
case 'cecanmalaysia':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
sendButton(from, "GOPAY : 0895606093746 (zaky)", faketeks, but, mek)
break
case 'dana':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
but = [
...
sendButton(from, "DANA : 0895606093746 (dimaszaky)", faketeks, but, mek)
break
case 'ovo':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
but = [
...
sendButton(from, "OVO : 0895606093746 (dimaszaky)", faketeks, but, mek)
break
case "runtime":
case "test":
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
but = [
        ...
        sendButImage(from, kimak, "©Ayyon Bot", gam, but)
break
case 'donasi':
...
Semoga Rejekinya Tambah Lancar Amin
    ...
    ╭───────────────❏
❍┤ヅ Gopay : 0895606093746
❍┤ヅ Dana : 0895606093746
❍┤ヅ Ovo : 0895606093746
❍┤ヅ Pulsa : 0895606093746
    ╰───────────────❏`
gam = fs.readFileSync('./zeroyt7/zerothumb.jpg')
but = [
          { buttonId: `${prefix}menu`, buttonText: { displayText: 'BACK TO MENU' }, type: 1 },
...
setTimeout( () => {
zeroyt7.sendMessage(from, ngebuff, image, { caption: '_Tebak bro!!! gak bisa jawab wajib pilih truth or dare Ayyon Bot :v_', quoted: ftrol }) 
}, 0) // 1000 = 1s,
break
case 'tembak':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
